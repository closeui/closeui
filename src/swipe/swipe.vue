<template>
  <div class="cl-swipe">
    ...
    <div v-else class="cl-swipe__track">
      <slot></slot>
    </div>
    <div class="cl-swipe__indicators" v-if="showIndicators && count > 1">
      <i v-for="index in count" :class="{ 'cl-swipe__indicator--active': index - 1 === activeIndicator }"></i>
    </div>
  </div>
</template>
<script>
